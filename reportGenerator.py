...
class ReportGenerator:
    ...
    def generateReport(self):
        """
        Write the report generated by HTMLReporter
        to the file specified in the config params.
        """

        # get the path and filename that will be
    ...
    def getPath(self):
        """
        If no output path has been configured then
